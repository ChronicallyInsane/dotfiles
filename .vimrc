...
"  "
  ...
  filetype plugin indent on		" Enable file type detection and do
 " language-dependent indenting.
  set history=100					" Default = 8
  set tabstop=4					" Default tabs are too
"  big
  set wrap						" Turn on word
 " wrapping
  set ai                          " autoindent
  set linebreak					" Only wrap at
  "sensible places
  set nolist						" list disables
"  linebreak
  set textwidth=0					" prevent Vim from
"  automatically inserting line breaks
  set wrapmargin=0
  set formatoptions-=t			" Don't change wrapping on existing
"  lines
  set formatoptions+=l			" Black magic
"  " to insert a real tab, use <Ctrl>-V <Tab>; this command expands tabs to
"  spaces
  set expandtab 
"  " shiftwidth
  set shiftwidth=4
...
"  " ## Other Tools
  ...
  Plug 'https://github.com/sirtaj/vim-openscad'	" OpenSCAD syntax
"  hilighting
  Plug 'itchyny/lightline.vim' " from
...
"      " Get rid of pointless Airline separators because I don't want to
"      install a
...
"      " # Color Scheme
      syntax on
      syntax enable			" I have no idea what this actually
"      does
      set background=dark
      if !has('gui_running')
          set t_Co=256			" 256 colors, terrible for most
"          themes, but best for Tomorrow-Night
...
"                                                        " Wordcount function
"                                                        from Pingouin
"                                                        (https://nanowrimo.org/participants/pingouin)
"                                                        function! WordCount()
"                                                        let s:old_status =
"                                                        v:statusmsg
"                                                        let position =
...
"                                                                                                   "
"                                                                                                   ---set
"                                                                                                   statusline+=%{strlen(&fenc)?&fenc:&enc},
"                                                                                                   "
"                                                                                                   encoding
"                                                                                                   "
"                                                                                                   ---set
...
"                                                                                                   "
"                                                                                                   ---set
"                                                                                                   statusline+=%{synIDattr(synID(line('.'),col('.'),1),'name')}\
"                                                                                                   "
"                                                                                                   highlight
"                                                                                                   "set
"                                                                                                   statusline+=%b,0x%-8B\
